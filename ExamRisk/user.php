...
<tbody>
    ...
    while($row = $result->fetch_assoc()){
        ...
        <td>
         <a class='btn btn-primary btn-sm' href='updateuser.php?UserID=$row[UserID]'>Edit</a>
         <a class='btn btn-danger btn-sm' href='deleteUser.php?UserID=$row[UserID]' role='button'>delete</a>
       </td>
       </tr>
       ";
    }
...
<div class="button2">
    <a class='btn' href='student.php'>Next page</a>
</div>
</body>
</html>